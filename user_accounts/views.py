...
class UserRegistrationApiView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            print("uid ", uid)
            confirm_link = f"https://food-shop-server.onrender.com/user_accounts/active/{uid}/{token}"
...
def activate(request, uid64, token):
    ...
    if user is not None and default_token_generator.check_token(user, token):
        ...
        user.save()
        return redirect('https://steady-concha-8cc923.netlify.app/login')
    else:
        return redirect('https://steady-concha-8cc923.netlify.app/register')
